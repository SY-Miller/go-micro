...
const (
	authenticateURL = "http://authentication-service:8080/authenticate"
	logURL          = "http://logger-service:8088/log"
)
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// call the service
	request, err := http.NewRequest("POST", authenticateURL, bytes.NewBuffer(jsonData))
	if err != nil {
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) LogViaGRPC(w http.ResponseWriter, r *http.Request) {
	...
	payload := jsonResponse{Error: false, Message: "Logged"}
